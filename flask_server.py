...
import os
import random
from flask import Flask, render_template, render_template_string, redirect, request , url_for
...
def upload():
    ...
    if urls:
        response_html += '<ul>'
        for url in urls:
            response_html += f'<li><a href="/static/mediaSource/nsfw/{os.path.basename(url)}" target="_blank">View File</a></li>'
